...
/**
 * Servlet implementation class SendPost3Servlet
 */
public class SendPost3Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SendPost3Servlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String sql="select post_id from postinfo where category='求学' order by likescount desc";
